...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    public List<Song> findSongsByTitle(String title) {
        ...
        return session.createQuery("from Song where lower(title) LIKE lower(:title)", Song.class).setParameter("title", title).list();
    }
    ...
    public List<Artist> findArtistsByName(String name) {
        ...
        return session.createQuery("from Artist where lower(name) LIKE lower(:name)", Artist.class).setParameter("name", name).list();
    }
    ...
    public List<Album> findAlbumsByAlbumTitle(String title) {
        ...
        return session.createQuery("from Album where lower(title) LIKE lower(:title)", Album.class).setParameter("title", title).list();
    }
